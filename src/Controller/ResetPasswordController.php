...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator, SessionInterface $session): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $res = $this->processSendingPasswordResetEmail(
                $form->get('email')->getData()
            );

            $session->set('reset_token', $res);
    ...
    private function processSendingPasswordResetEmail(string $emailFormData): ResetPasswordToken
    {
